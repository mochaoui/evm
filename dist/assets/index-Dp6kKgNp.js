import{s as v,i as C,p as O,j as k,r as g,l as m,m as h,O as l}from"./index-ZX-x4mda.js";import{n as b,c as y,r as _}from"./index-C4DDhrm3.js";import{o as j}from"./if-defined-BBfispRG.js";import{e as L,n as R}from"./ref-DpQNo4k8.js";const d=O({isLegalCheckboxChecked:!1}),f={state:d,subscribe(e){return C(d,()=>e(d))},subscribeKey(e,t){return v(d,e,t)},setIsLegalCheckboxChecked(e){d.isLegalCheckboxChecked=e}},z=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var x=function(e,t,s,n){var i=arguments.length,o=i<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,s):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,s,n);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(o=(i<3?r(o):i>3?r(t,s,o):r(t,s))||o);return i>3&&o&&Object.defineProperty(t,s,o),o};const E={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=L(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=E[this.size];return h`
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};a.styles=[g,z];x([b({type:Boolean})],a.prototype,"checked",void 0);x([b({type:Boolean})],a.prototype,"disabled",void 0);x([b()],a.prototype,"size",void 0);a=x([y("wui-checkbox")],a);const P=k`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
