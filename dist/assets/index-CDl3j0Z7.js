import{j as c,r as h,k as m,l as b,m as r}from"./index-ZX-x4mda.js";import{n,c as x}from"./index-C4DDhrm3.js";import{o as f}from"./if-defined-BBfispRG.js";import{e as $,n as g}from"./ref-DpQNo4k8.js";const w=c`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var i=function(t,a,s,u){var p=arguments.length,o=p<3?a:u===null?u=Object.getOwnPropertyDescriptor(a,s):u,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,a,s,u);else for(var d=t.length-1;d>=0;d--)(l=t[d])&&(o=(p<3?l(o):p>3?l(a,s,o):l(a,s))||o);return p>3&&o&&Object.defineProperty(a,s,o),o};let e=class extends b{constructor(){super(...arguments),this.inputElementRef=$(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return r` <div class="wui-input-text-container">
