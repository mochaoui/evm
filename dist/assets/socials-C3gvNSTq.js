import{j as L,l as O,z as E,O as h,L as k,R as f,d as W,m as c,a as v,P as T,x as F,C as d,o as S,E as u,G as U,S as C,Q as D,M as I,T as y}from"./index-ZX-x4mda.js";import{n as N,r as l,c as _}from"./index-C4DDhrm3.js";import{o as $}from"./if-defined-BBfispRG.js";import{O as R}from"./index-Dp6kKgNp.js";import{e as j}from"./index-B_pitBeK.js";import"./index-rMxDyUaj.js";import{C as M}from"./ConstantsUtil-COJBkkkj.js";import"./index-CDzi_t8A.js";import"./index-BIG0ZZgf.js";import"./index-DPlnCEIh.js";import"./ref-DpQNo4k8.js";import"./index-CtXNEAUz.js";import"./index-CxWDaxMn.js";const z=L`
  :host {
...
`;var g=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let p=class extends O{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=E.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=k.state.plan.hasExceededUsageLimit,this.unsubscribe.push(E.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const i=!!this.authConnector,r=e?.length,s=f.state.view==="ConnectSocials";return(!i||!r)&&!s?null:(s&&!r&&(e=W.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
      ${e.map(o=>c`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){f.push("UsageExceeded");return}e&&await j(e)}async handlePwaFrameLoad(){if(v.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof T&&await this.authConnector.provider.init()}catch(e){F.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};p.styles=z;g([N()],p.prototype,"tabIdx",void 0);g([l()],p.prototype,"connectors",void 0);g([l()],p.prototype,"authConnector",void 0);g([l()],p.prototype,"remoteFeatures",void 0);g([l()],p.prototype,"isPwaLoading",void 0);g([l()],p.prototype,"hasExceededUsageLimit",void 0);p=g([_("w3m-social-login-list")],p);const q=L`
  wui-flex {
...
`;var A=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let P=class extends O{constructor(){super(),this.unsubscribe=[],this.checked=R.state.isLegalCheckboxChecked,this.unsubscribe.push(R.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:i}=h.state,r=h.state.features?.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};P.styles=q;A([l()],P.prototype,"checked",void 0);P=A([_("w3m-connect-socials-view")],P);const G=L`
  wui-logo {
    width: 80px;
    height: 80px;
...
`;var x=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let w=class extends O{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=d.getAccountData()?.socialProvider,this.uri=d.getAccountData()?.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=h.state.remoteFeatures,this.authConnector=E.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(d.subscribeChainProp("accountState",e=>{this.socialProvider=e?.socialProvider,this.uri=e?.farcasterUrl,this.connectFarcaster()}),h.subscribeKey("remoteFeatures",e=>{this.remoteFeatures=e})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate),!d.state.activeCaipAddress&&this.socialProvider&&(this.uri||this.loading)&&u.sendEvent({type:"track",event:"SOCIAL_LOGIN_CANCELED",properties:{provider:this.socialProvider}})}render(){return this.onRenderProxy(),c`${this.platformTemplate()}`}platformTemplate(){return v.isMobile()?c`${this.mobileTemplate()}`:c`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?c`${this.loadingTemplate()}`:c`${this.qrTemplate()}`}qrTemplate(){return c` <wui-flex
    ...
    >
      ...
      Copy link
    </wui-button>`}onCopyUri(){try{this.uri&&(v.copyToClopboard(this.uri),C.showSuccess("Link copied"))}catch{C.showError("Failed to copy")}}};w.styles=B;x([l()],w.prototype,"socialProvider",void 0);x([l()],w.prototype,"uri",void 0);x([l()],w.prototype,"ready",void 0);x([l()],w.prototype,"loading",void 0);x([l()],w.prototype,"remoteFeatures",void 0);w=x([_("w3m-connecting-farcaster-view")],w);export{P as W3mConnectSocialsView,w as W3mConnectingFarcasterView,m as W3mConnectingSocialView};
